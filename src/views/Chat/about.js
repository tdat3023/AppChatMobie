      ...
      <View style={styles.container}>
        <View style={styles.ViewTop}>
          ...
          <View style={styles.viewListOpstion}>
            <TouchableOpacity>
              <View style={styles.viewListIcon}>
                <View style={styles.viewIcon}>
                  <Ionicons style={{lineHeight: 40}} name="search" size={25} />
                </View>
                <Text
                  style={{
                    textAlign: 'center',
            ...
            <TouchableOpacity>
              <View style={styles.viewListIcon}>
                <View style={styles.viewIcon}>
                  <Ionicons style={{lineHeight: 40}} name="person" size={25} />
                </View>
                <Text
                  style={{
                    textAlign: 'center',
        ...
        <View style={styles.viewCustomization}>
          <TouchableOpacity>
            <View style={styles.viewItem}>
              ...
              <View style={styles.viewCustomItem}>
                <Text style={{fontSize: 15}}>Change Nicknames</Text>
                <Ionicons
                  style={{}}
                  color={'gray'}
          ...
          <View style={styles.viewItem}>
            ...
            <View style={styles.viewCustomItem}>
              <Text style={{fontSize: 15}}>Hide this conversation</Text>
              <ToggleSwitch
                isOn={switchOnPin}
                onColor="#33C481"
                offColor="#E4E6EB"
          ...
          <View style={styles.viewItem}>
            ...
            <View style={styles.viewCustomItem}>
              <Text style={{fontSize: 15}}>Pin this conversation</Text>
              <ToggleSwitch
                isOn={switchOn}
                onColor="#33C481"
                offColor="#E4E6EB"
          ...
          <TouchableOpacity>
            <View style={styles.viewItem}>
              ...
              <View style={styles.viewCustomItem}>
                <Text style={{fontSize: 15}}>Delete chat histoty</Text>
              </View>
            </View>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.viewCustomization}>
          <TouchableOpacity>
            <View style={styles.viewItem}>
              ...
              <View style={styles.viewCustomItem}>
                <Text style={{fontSize: 15}}>View media, file & link</Text>
                <Ionicons
                  style={{}}
                  color={'gray'}
                  name="chevron-forward-outline"
          ...
          <TouchableOpacity>
            <View style={styles.viewItem}>
              ...
              <View style={styles.viewCustomItem}>
                <Text style={{fontSize: 15}}>Create group with {user}</Text>
                <Ionicons
                  style={{}}
                  color={'gray'}
                  name="chevron-forward-outline"
          ...
          <TouchableOpacity>
            <View style={styles.viewItem}>
              ...
              <View style={styles.viewCustomItem}>
                <Text style={{fontSize: 15}}>Add {user} to groups</Text>
                <Ionicons
                  style={{}}
                  color={'gray'}
                  name="chevron-forward-outline"
          ...
          <TouchableOpacity>
            <View style={styles.viewItem}>
              ...
              <View style={styles.viewCustomItem}>
                <Text style={{fontSize: 15}}>View groups in common</Text>
                <Ionicons
                  style={{}}
                  color={'gray'}
                  name="chevron-forward-outline"
        ...
        <View style={styles.viewCustomization}>
          <TouchableOpacity>
            <View style={styles.viewItem}>
              ...
              <View style={styles.viewCustomItem}>
                <Text style={{fontSize: 15}}>Report</Text>
              </View>
            </View>
          </TouchableOpacity>
          <TouchableOpacity>
